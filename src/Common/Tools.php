...
use NFePHP\NFs\RJ\Soap\SoapCurl;
use NFePHP\NFs\RJ\Soap\SoapInterface;
use NFePHP\Common\Certificate;
use NFePHP\NFs\RJ\Factories\Webservices;
use NFePHP\Common\Signer;
use NFePHP\Common\Validator;
use NFePHP\NFs\RJ\Common\EntitiesCharacters;
...
class Tools {
    ...
    */
     ...
     * @var string
     */
    protected $urlPortal = 'http://notacarioca.rio.gov.br';
    ...
    */
    ...
    public function makeBody($method, $mensagemXML){
        ...
        $request = "<inputXML>$mensagemXML</inputXML>";
